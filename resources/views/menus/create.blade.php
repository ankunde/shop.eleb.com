...
@section('contents')
    <form action="{{route('menus.store')}}" method="post" enctype="multipart/form-data">
        ...
        <div class="form-group">
            ...
            <input type="number" class="form-control" name="goods_price" id="password1">
        </div>

        <div class="form-group">
            <label for="password">描述</label>
            <input type="password" class="form-control" name="description" id="password">
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <input type="number" class="form-control" id="shop_im" name="shop_img">
        </div>
        <div class="form-group">
            <label for="shop_im">提示信息</label>
            <input type="text" class="form-control" id="shop_im" name="tips">
        </div>
        <div class="form-group">
            <label for="shop_im">满意度数量</label>
            <input type="number" class="form-control" id="shop_im" name="satisfy_count">
        </div>
        <div class="form-group">
            <label for="shop_im">满意度评分</label>
            <input type="number" class="form-control" id="shop_im" name="satisfy_rate">
        </div>
        <div class="form-group">
            <label for="shop_im">商品图片</label>
            <input type="file"  id="shop_im" name="satisfy_rate">
        </div>
